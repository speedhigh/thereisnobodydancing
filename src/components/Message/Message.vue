<template>
  <Transition name="down">
    <div 
      v-show='isShow' 
      class="alert shadow-lg w-[400px] h-14 fixed z-[9999] top-7 left-1/2 -ml-[200px]"
      :class="[{'alert-warning': type === 'warn'}, {'alert-success': type === 'success'}, {'alert-error': type === 'error'}, {'': type==='info'}]"
    >
      <div>
